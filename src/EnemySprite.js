...
export default class EnemySprite extends Sprite {
    ...
    draw() {
        ...
        this.shape === 'rectangle' ? drawRectangle(this.ctx, -50, -50, 10* this.scale, 10* this.scale, healthColor(this.maxHealth,this.health)) : drawCircle(this.ctx, 0, 0, 10 * this.scale, healthColor(this.maxHealth,this.health));
        this.ctx.restore();
    }
}